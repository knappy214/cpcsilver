...
uint256 hashGenesisBlock("0x729ca8c517e4de1ca20043fd9d03c7ce62fa52cc4f0b63836ae006de3e0b7a84");
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal cpscoin miner
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "This is the Artificial Intelligence CPSGOLD coin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1478084372; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 638370;

        if (fTestNet)
        {
            block.nTime    = 1478084372;
            block.nNonce   = 68049;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x48d263e7a5a9a88e0cde4200bd8b9bea726a2fabe0bc3a7c0f898f5e1f3e6fa7"));
